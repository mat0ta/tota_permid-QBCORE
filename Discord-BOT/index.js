...
client.on('message', async message => {
    ...
    if (command == "checkid") {
        ...
        var code = "SELECT name FROM players WHERE `permid` = '" + type + "'";
    ...
    var license = "SELECT license FROM players WHERE `permid` = '" + type + "'";
    ...
    var discord = "SELECT discord FROM players WHERE `permid` = '" + type + "'";
        ...
        var amount = "SELECT steam FROM players WHERE `permid` = '" + type + "'";
